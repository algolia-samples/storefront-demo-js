...
<x-layout>
    ...
    <div aria-hidden="true" class="absolute inset-0 hidden sm:flex sm:flex-col">
        ...
        <div class="absolute inset-0 overflow-hidden">
            <img src="/images/mark-chan-489jbTi51sg-unsplash-optimized.jpg" alt="" class="h-full w-full object-cover object-center">
        </div>
    ...
    <div class="relative mx-auto max-w-3xl px-4 pb-96 text-center sm:px-6 sm:pb-0 lg:px-8">
        ...
        <div class="mt-4 sm:mt-6">
            <a href="{{ url('/search') }}" class="inline-block rounded-md border border-transparent bg-white py-3 px-8 font-medium text-black">Browse now</a>
        </div>
        </div>
    </div>
                ...
                <div>
                    <div aria-hidden="true" class="absolute inset-0 overflow-hidden rounded-lg">
                        <div class="absolute inset-0 overflow-hidden group-hover:opacity-75">
                            <img src="{{ $category['imageSrc'] }}" alt="" class="w-full h-auto object-center object-fit group-hover:scale-110 transition-transform {{ $category['className'] }}" width="500" height="500">
                        </div>
        ...
        @foreach ($mock['home']['trendingProducts'] as $trending)
            <div class="group relative">
                <div class="h-56 w-full overflow-hidden rounded-md group-hover:opacity-75 lg:h-72 xl:h-80">
                    <img src="{{ $trending['imageSrc'] }}" alt="{{ $trending['imageAlt'] }}" class="h-full w-full object-cover object-center">
                </div>
